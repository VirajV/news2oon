...
const enhancePromptSafety = (prompt: string): string => {
  ...
  return `Create a simple editorial cartoon illustration showing: ${safePrompt}. Style: clean newspaper editorial cartoon style, minimal detail, clear visual message. Keep it family-friendly and avoid any controversial or sensitive content.`;
};
